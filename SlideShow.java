...
public class SlideShow extends JFrame {
	...
	private void initComponent() {
		...
		setTitle("Top 8 Destinations SlideShow");
	...
	private String getResizeIcon(int i) {
		...
		// code reflects eight images for destinations
		return image;
	}
	...
	private String getTextDescription(int i) {
		...
		if (i==1){
			...
			text = "<html><body>#5 Top Destination</body></html>";
				...
				text = "<html><body>#6 Top Destination</body></html>";
		} else if (i==5){
			text = "<html><body>#7 Top Destination</body></html>";
		} else if (i==5){
		text = "<html><body>#8 Top Destination</body></html>";
		}

		// Updated destination text valaues to reflect eight destinations // 
		return text;
	}
